...
<section id="contact" class="py-24" data-scroll-reveal>
    <div class="container mx-auto px-4">
        ...
        <div class="flex flex-col lg:flex-row lg:gap-16">
            ...
            <div class="lg:w-1/2 flex flex-col lg:items-start lg:text-right lg:items-end">
                
                <?php if ($title) : ?>
                    <h2 class="flextext-4xl font-serif text-brand-azul-escuro">
                    ...
                    <div class="flex gap-4">
                        ...
                        ?>
                            <a href="<?php echo esc_url($url); ?>" target="_blank" 
                               class="w-12 h-12 bg-brand-marrom text-white p-3 rounded-full hover:bg-brand-azul-escuro transition-colors">
                                <?php if ($icon): ?>
