 ...
 */
$image_banner = get_field('imagem_banner', 'option');
$image_banner_url = $image_banner ? $image_banner['url'] : '';

$titulo_banner = get_field('titulo_banner', 'option');
$link_whatsapp = get_field('link_whatsapp', 'option');
$icone = get_field('icone_whatsapp', 'option');
$texto_botao = get_field('texto_botao_whatsapp', 'option');
