...
<!-- Container Principal -->
<div id="tag-feed" class="w-full bg-brand-off-white min-h-screen py-16 px-4 sm:px-6 lg:px-8">
    <main class="max-w-7xl mx-auto">

        <!-- Breadcrumb -->
        <nav class="mb-12 text-xs font-sans font-bold uppercase tracking-widest text-brand-azul-escuro/60">
            <a href="<?php echo home_url(); ?>" class="hover:text-brand-marrom transition-colors">Início</a>
            <span class="mx-2">›</span>
            <?php 
            $blog_page_id = get_option('page_for_posts');
            if ($blog_page_id) : ?>
                <a href="<?php echo get_permalink($blog_page_id); ?>" class="hover:text-brand-marrom transition-colors">Blog</a>
                <span class="mx-2">›</span>
            <?php endif; ?>
            <span class="text-brand-marrom"><?php single_tag_title(); ?></span>
        </nav>
            ...
            <div class="w-full lg:w-3/4">
                ...
                <?php else : ?>
                    ...
                    <div class="text-center py-20 bg-white border border-brand-azul-escuro/5 p-10">
                        <p class="font-serif text-xl text-brand-azul-escuro mb-4">Nenhum post encontrado com a tag #<?php single_tag_title(); ?>.</p>
